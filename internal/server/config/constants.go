...
const (
	...
	EnvUploadSessionCleanupIntervalMinutes = "GOPHKEEPER_UPLOAD_SESSION_CLEANUP_INTERVAL_MINUTES"
)
...
const (
	...
	DefaultUploadSessionCleanupIntervalMinutes = 15
...
const (
	...
	UploadSessionCleanupRunTimeoutSeconds = 120
	UploadSessionCleanupListBatchSize     = 100
)
